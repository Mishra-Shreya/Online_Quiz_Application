...
#### _If the user tries to go back to change the answers --> The questions along with the options are reshuffled_
...
#### Authentication Check - _If a new user registers with the already existing username_:
...
#### Authentication Check - _If login credentials mismatch_:
